...
class Users
{
    ...
    function __construct()
    {
        ...
        $dbServer = "cornholeaws-test.c6sgbeek7pg2.us-east-1.rds.amazonaws.com";
        $dbUsername = "cornhole";
        $dbPassword = "playthrowtoss";
...
//    {
//
//        $prev_query = mysqli_query($this->connect, "SELECT * FROM " . $this->table_name . " WHERE oauth_provider = '" . $oauth_provider . "' AND oauth_uid = '" . $oauth_uid . "');
//        if(mysqli_num_rows($prev_query)>0){
//            $update = mysqli_query($this->connect,"UPDATE $this->table_name SET oauth_provider = '".$oauth_provider."', oauth_uid = '".$oauth_uid."');
//        } else {
//            $insert = mysqli_query($this->connect,"INSERT INTO $this->table_name SET oauth_provider = '".$oauth_provider."', oauth_uid = '".$oauth_uid."');
//        }
//        $query = mysqli_query($this->connect,"SELECT * FROM $this->table_name WHERE oauth_provider = '".$oauth_provider."' AND oauth_uid = '".$oauth_uid."');
//        $result = mysqli_fetch_array($query);
//        return $result;
