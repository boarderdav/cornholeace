...
<div class="container">
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="col-xs-12">
                <img src="/img/CornholeBags-RedBlueAllFinal.jpg" alt="blue and red cornhole bags" class="img-responsive">
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-xs-3">
                    <div class="thumbnail" data-toggle="modal" data-target="#myModal4">
                        <img class="img-responsive" src="/img/cornholegirls1.jpg"/>
                    </div>
                </div>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-6 col-sm-12 hero-feature">
                <div class="thumbnail">
                    <a href="http://shop.cornholeace.com/professionalset.php">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            <a href="https://tgs.celeryshop.com/checkout?product_id=56ce3a7be4ad561100af4c92" class="btn btn-primary">Buy Now!</a> <a href="http://shop.cornholeace.com/professionalset.php" class="btn btn-default">More Info</a>
                        </p>
                    </div>
                </div>
            </div>
